...
BOOKINGID INT CONSTRAINT Bookref1 REFERENCES BOOKINGS(ID)
)
;
...
CREATE TABLE ROOMTYPES (TYPE CHAR(10) PRIMARY KEY, NUMBEDS INT NOT NULL, PRICE INT NOT NULL);
INSERT INTO ROOMTYPES VALUES("Single",1,70),('Twin Bed',2,120),('Queen',1,120),('Executive',1,180),('Suite',2,300);


insert into Bookings (Checkin,checkout,custid,cityid,roomtype,extrabed,cardnum,pin,fair) values 
(08052014,31062014,'sam',1,'Single',true,001000,412,60),
(09102014,25122014,'Has',2,'Single',true,001000,412,60),
(14082014,06092014,'Wifi',3,'Queen',true,001000,412,60),
(14082014,06092014,'Waji',1,'Executive',true,001000,412,60),
(08052014,31062014,'sam',1,'Suit',true,001000,412,60)
;
